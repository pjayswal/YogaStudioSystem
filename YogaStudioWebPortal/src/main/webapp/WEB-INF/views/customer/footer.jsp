	...
	<div class="col-lg-12">
		<div class="row footer-top">
			<div class="col-lg-3 border_right_column">
				<ul>
					<li><a href="<c:url value="/customer/home" />"><strong>HOME</strong></a></li>
			...
			<div class="col-lg-3">
				<ul>
					<li>Use My YOGA STUDIO for all of your status updates as well
						as Project Proposal.</li>
					<li>&nbsp;</li>
					<li><a class="btn btn-lg btn-primary my-yoga-studio"
						href="<c:url value="/login.jsp" />" role="button">MY YOGA <b
